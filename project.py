...
def initDB():
    ...
    mycursor.execute('''USE test1db;''')
    
    #mycursor.execute("INSERT INTO `supplier` (`name`, `location` ) VALUES ('FreeFood', 'Address Blvd.')")
    mycursor.execute("SELECT * FROM supplier WHERE name='FreeFood'")
